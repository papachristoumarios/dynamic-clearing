...
# python3 main.py --name tlc -B 100 -L 10 --num_iters 1 --method discrete --gini 0.5 --gini_type standard
# python3 main.py --name safegraph -B 500000 --method discrete --num_iters 1 --gini 0.5 --gini_type standard
